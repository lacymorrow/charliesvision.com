...
b)},setOptions:function(a){e.extend(this.options,a);return this},_call:function(a,b){var c="https://api.flickr.com/services/rest/?",d=this,a=e.extend({format:"json",jsoncallback:"?",api_key:this.api_key},a);e.each(a,function(a,b){c+="&"+a+"="+b});e.getJSON(c,function(a){a.stat==="ok"?b.call(d,a):Galleria.raise(a.code.toString()+" "+a.stat+": "+a.message,!0)});return d},_getBig:function(a){if(a.url_l)return a.url_l;else if(parseInt(a.width_o,10)>1280)return"https://farm"+a.farm+".static.flickr.com/"+
...
a.photoset.photo,e=Math.min(this.options.max,a.length),f,g;for(g=0;g<e;g++)f=a[g],d.push({thumb:this._getSize(f,this.options.thumbSize),image:this._getSize(f,this.options.imageSize),big:this._getBig(f),title:a[g].title,description:this.options.description&&a[g].description?a[g].description._content:"",link:this.options.backlink?"https://flickr.com/photos/"+f.owner+"/"+f.id:""});b.call(this,d)})}};var h=Galleria.prototype.load;Galleria.prototype.load=function(){if(arguments.length||typeof this._options.flickr!==
