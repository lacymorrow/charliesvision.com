...
(function () {
  ...
  // Auto-init if #galleria exists on DOM ready
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', function () { renderGallery('#galleria'); });
  } else {
    renderGallery('#galleria');
  }
})();
